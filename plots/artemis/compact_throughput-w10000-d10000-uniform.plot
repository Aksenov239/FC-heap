...
% -- 800000
   ...
   \nextgroupplot[title=Range: 100, ylabel={Size: 800000}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_100_LindenSkipList.dat};\label{plots:linden}
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_100_SkipQueue.dat};\label{plots:skipqueue}
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_100_BlockingBinaryHeap.dat};\label{plots:blocking}
   ...
   \nextgroupplot[title=Range: $10^4$, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_10000_BlockingBinaryHeap.dat};
...
%       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_1600000_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[title=Range: $2^{31}$, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_800000_2147483647_BlockingBinaryHeap.dat};
...
% -- 2000000
   ...
   \nextgroupplot[ylabel={Size: 2000000}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_2000000_100_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_2000000_10000_BlockingBinaryHeap.dat};
...
%       \addplot table {data/w10000-d10000/uniform/comparison_throughput_2000000_4000000_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_2000000_2147483647_BlockingBinaryHeap.dat};
...
% -- 4000000
   ...
   \nextgroupplot[ylabel={Size: 4000000}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_4000000_100_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_4000000_10000_BlockingBinaryHeap.dat};
...
%       \addplot table {data/w10000-d10000/uniform/comparison_throughput_4000000_8000000_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_4000000_2147483647_BlockingBinaryHeap.dat};
...
% -- 8000000
  ...
  \nextgroupplot[ylabel={Size: 8000000}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_8000000_100_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_8000000_10000_BlockingBinaryHeap.dat};
...
%       \addplot table {data/w10000-d10000/uniform/comparison_throughput_8000000_16000000_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_8000000_2147483647_BlockingBinaryHeap.dat};
...
% -- 20000000
  ...
  \nextgroupplot[xlabel={Number of Threads}, ylabel={Size: 20000000}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_20000000_100_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[xlabel={Number of Threads}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_20000000_10000_BlockingBinaryHeap.dat};
...
%       \addplot table {data/w10000-d10000/uniform/comparison_throughput_20000000_40000000_BlockingBinaryHeap.dat};
   ...
   \nextgroupplot[xlabel={Number of Threads}, cycle list name=color]
       ...
       \addplot table {data/w10000-d10000/uniform/comparison_throughput_20000000_2147483647_BlockingBinaryHeap.dat};
