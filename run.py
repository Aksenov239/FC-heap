...
#        allranges.append(2 * size)
        for r in allranges:
            for benchmark in benchmarks:
                ...
                command = "java -server -Xmx2G -Xss256M -XX:+UseCompressedOops -cp {} {} -n {} -t {} -w {} -d {} -s {} -r {} -b {} > {}".format(classpath, mainclass, iterations, proc, warmup, duration, size, r, benchmark, out)
                print(command)
                os.system(command)
